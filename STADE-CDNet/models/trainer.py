...
class CDTrainer():
    ...
    def __init__(self, args, dataloaders):
        ...
        if args.optimizer == "sgd":
            ...
            self.optimizer_G = optim.AdamW(self.net_G.parameters(), lr=self.lr,
                                    betas=("x", "y"), weight_decay=0.05)# x, y must be set.
    ...
    def _collect_running_batch_states(self):
        ...
        if np.mod(self.batch_id, 200) == 1:
            ...
            file_name = os.path.join(
                '/where', 'istrain_'+str(self.is_training)+'_'+
    ...
    def train_models(self):
        ...
        for self.epoch_id in range(self.epoch_to_start, self.max_num_epochs):
            ...
            for self.batch_id, batch in tqdm(enumerate(self.dataloaders['train'], 1), total=total):
